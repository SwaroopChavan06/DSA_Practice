...
public class bottomViewNode {
    ...
    public void bottomview() {
        TreeNode leaf = botmviewprint(root);
    }

    private TreeNode botmviewprint (TreeNode root) {
        if (root == null) {
            return null;
        }
        ...
        botmviewprint(root.left);
        botmviewprint(root.right);
        return root;
    }

    public static void main(String[] args) {
        bottomViewNode bst = new bottomViewNode();
        bst.insert(25);
        bst.insert(12);
        bst.insert(5);
        bst.insert(4);
